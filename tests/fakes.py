...
class MockClient(mango.BetterClient):
    def __init__(self) -> None:
        ...
        super().__init__(MockCompatibleClient(), None, "test", "local", Commitment("processed"),
                         False, -1, "base64", 0, compound)
...
def fake_model_state(order_owner: typing.Optional[PublicKey] = None,
    ...
    price_watchers: typing.Dict[mango.ManualUpdateWatcher[mango.Price]] = {'fake': mango.ManualUpdateWatcher(price)}
    ...
    return mango.ModelState(order_owner, market, group_watcher, account_watcher, price_watchers,
