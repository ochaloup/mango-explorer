...
from mango.oracles.binance.binance import BinanceOracle
from mango.oracles.kraken.kraken import KrakenOracle
...
def main(args: argparse.Namespace) -> None:
    try:
        ...
        def get_oracle(
            chkp_cfg: ChkpContextConfiguration,
            oracle_name: str,
            symbol: str
        ...
        oracles = {
            oracle_name: {
                symbol: get_oracle(context.cfg, oracle_name, symbol)
